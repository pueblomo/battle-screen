      ...
      >
        <div className="grid gap-2">
          ...
          {(monster.action || monster.spellcasting) && (
            <Feature
              monsterFeatures={monster.action}
              title={"Actions"}
              spells={monster.spellcasting}
              display={"action"}
            />
          ...
          {(monster.reaction || monster.spellcasting) && (
            <Feature
              monsterFeatures={monster.reaction}
              title={"Reactions"}
              spells={monster.spellcasting}
              display={"reaction"}
            />
          ...
          {(monster.legendary || monster.spellcasting) && (
            <Feature
              monsterFeatures={monster.legendary}
              title={"Legendary Actions"}
              spells={monster.spellcasting}
              display={"legendary"}
            >
              <div className="italic text-gray-600 text-xs text-left mb-2">
                Legendary Action Uses: 3{" "}
                {monster.legendaryActionsLair
                  ? `(${monster.legendaryActionsLair} in Lair)`
                  : ``}
                . Immediately after another creature's turn, the {monster.name}{" "}
                can expend a use to take one of the following actions. The{" "}
                {monster.name} regains all expended uses at the start of each of
                its turns.
              </div>
            </Feature>
          )}
